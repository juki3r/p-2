                ...
                <div class="col-12">
                    <div class="card mb-5">
                        <div class="card-header">
                            <h3 class="px-1">
                                PISOWIFI
                                <a href="expenses.php" class="btn btn-primary btn-sm float-end px-2">Next</a>
                                ...
                                <table class="table table-bordered table-striped table-hover text-nowrap table-sm">
                                    <caption>Project-2</caption>
                                        ...
                                        <tr > 
                                            ...
                                            <th colspan="1" class="text-center py-3 text-light" style="font-size: 20px !important; background-color:#433878;">Remarks</th>
                                        </tr>
                                    ...
                                    <?php
                                        ...
                                        <tr class="mt-4" >
                                            ...
                                            <td class="text-center">&#8595;</td>
                                            <td class="text-center">&#8595;</td>
                                            <td colspan="1" style="color:transparent">x</td>
                                        </tr>
                                        <tr class="mt-4" >
                                        <td colspan="2" style="color:transparent">x</td>
                                            <td class="text-center bg-warning">&#8595;</td>
                                        ...
                                        <tr class="mt-4" style="border: 1px solid black;">
                                            ...
                                            <?php
                                                ...
                                                while($row = mysqli_fetch_array($query_run)){
                                                    ...
                                                    echo '<td colspan="1" class="text-center bg-success text-light py-2">&#8369; '.$total.'.00</td>';
                                                }
